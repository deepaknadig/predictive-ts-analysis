...
confidence intervals.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}121}]:} \PY{c+c1}{\PYZsh{} Commonly used methods}
...
Date:                Sun, 17 Jun 2018   AIC                           3457.942
Time:                        16:31:54   BIC                           3470.972
...
-----------------------------------------------------------------------------
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{n}{plot\PYZus{}acfs}\PY{p}{(}\PY{n}{mdl}\PY{o}{.}\PY{n}{resid}\PY{p}{,} \PY{n}{lags}\PY{o}{=}\PY{n}{max\PYZus{}lag}\PY{p}{)}
\end{Verbatim}
...
Series}\label{armap-q-model-fit-for-gridftp-series}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{c+c1}{\PYZsh{} pick best order by aic }
...
AIC: 3305.68098 | Best Order: (4, 3)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n}{best\PYZus{}mdl}\PY{o}{.}\PY{n}{summary}\PY{p}{(}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
Date:                Sun, 17 Jun 2018   AIC                           3305.681
Time:                        16:33:06   BIC                           3331.741
...
-----------------------------------------------------------------------------
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{n}{plot\PYZus{}acfs}\PY{p}{(}\PY{n}{best\PYZus{}mdl}\PY{o}{.}\PY{n}{resid}\PY{p}{,} \PY{n}{lags}\PY{o}{=}\PY{n}{max\PYZus{}lag}\PY{p}{)}
\end{Verbatim}
...
Series}\label{arimap-q-model-fit-for-gridftp-series}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{\PYZsh{} Fit ARIMA(p, d, q) model to the GridFTP series}
...
AIC: 3281.80302 | Order: (5, 1, 5)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n}{best\PYZus{}mdl\PYZus{}arima}\PY{o}{.}\PY{n}{summary}\PY{p}{(}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
Date:                Sun, 17 Jun 2018   AIC                           3281.803
Time:                        16:40:19   BIC                           3317.578
...
-----------------------------------------------------------------------------
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{n}{plot\PYZus{}acfs\PYZus{}resids}\PY{p}{(}\PY{n}{best\PYZus{}mdl\PYZus{}arima}\PY{o}{.}\PY{n}{resid}\PY{p}{,} \PY{n}{lags}\PY{o}{=}\PY{n}{max\PYZus{}lag}\PY{p}{)}
\end{Verbatim}
...
ARIMA(p,d,q)}\label{forecast-the-gridftp-series-using-arimapdq}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}34}]:} \PY{c+c1}{\PYZsh{} Create a 10 hour forecast of GridFTP CMSProd connections with 95\PYZpc{}, 99\PYZpc{} CIs}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}34}]:}                      CI 95\% (lower)  CI 95\% (upper)  CI 99\% (lower)  \textbackslash{}
         Timeline                                                              
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}44}]:} \PY{c+c1}{\PYZsh{} Prediction Error (Actual is 4333)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
4606.0089564158825
Absolute Percentage Error (APE): 6.3006913550861405\%

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}116}]:} \PY{n}{fig} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{12}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}116}]:} <matplotlib.legend.Legend at 0x7f02749da208>
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}122}]:} \PY{n}{plot\PYZus{}acfs\PYZus{}resids1}\PY{p}{(}\PY{n}{best\PYZus{}mdl\PYZus{}arima}\PY{o}{.}\PY{n}{resid}\PY{p}{,} \PY{n}{lags}\PY{o}{=}\PY{n}{max\PYZus{}lag}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}123}]:} \PY{n}{plot\PYZus{}acfs\PYZus{}resids2}\PY{p}{(}\PY{n}{best\PYZus{}mdl\PYZus{}arima}\PY{o}{.}\PY{n}{resid}\PY{p}{,} \PY{n}{lags}\PY{o}{=}\PY{n}{max\PYZus{}lag}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}124}]:} \PY{n}{plot\PYZus{}acfs\PYZus{}resids3}\PY{p}{(}\PY{n}{best\PYZus{}mdl\PYZus{}arima}\PY{o}{.}\PY{n}{resid}\PY{p}{,} \PY{n}{lags}\PY{o}{=}\PY{n}{max\PYZus{}lag}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}125}]:} \PY{n}{plot\PYZus{}acfs\PYZus{}resids4}\PY{p}{(}\PY{n}{best\PYZus{}mdl\PYZus{}arima}\PY{o}{.}\PY{n}{resid}\PY{p}{,} \PY{n}{lags}\PY{o}{=}\PY{n}{max\PYZus{}lag}\PY{p}{)}
\end{Verbatim}
